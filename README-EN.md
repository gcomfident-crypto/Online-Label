...
>   <tr>
>     <td valign="top">
>       <strong>Owner Password Access</strong><br /><br />
>       The Owner role controls task creation, publishing, editing, and deletion across the labeling workflow, so its password is not public. To request an Owner role demo, scan the Feishu QR code on the right to contact Zhang Zexin.<br /><br />
>       You can also search for "张泽鑫" in the AI Full-Stack Challenge on Feishu and place an urgent Feishu call.
>     </td>
>     <td align="center" width="180">
>       <img src="./docs/readme/feishu-contact-qr.jpg" width="150" alt="Feishu QR code for Zhang Zexin" /><br />
>       <sub>Scan with Feishu</sub>
>     </td>
>   </tr>
> </table>
