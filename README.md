...
>   <tr>
>     <td valign="top">
>       <strong>Owner 密码获取</strong><br /><br />
>       Owner 角色掌管整条标注任务的创建、发布、修改和删除，密码不公开。需要演示 Owner 角色时，请直接使用飞书扫描右侧二维码联系张泽鑫。<br /><br />
>       也可以直接在 AI全栈挑战赛中搜索「张泽鑫」，飞书加急电话。
>     </td>
>     <td align="center" width="180">
>       <img src="./docs/readme/feishu-contact-qr.jpg" width="150" alt="飞书扫码联系张泽鑫" /><br />
>       <sub>飞书扫码联系</sub>
>     </td>
>   </tr>
> </table>
