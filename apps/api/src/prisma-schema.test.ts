...
describe('Prisma schema', () => {
  ...
  it('keeps review trace fields and audit transitions', () => {
    ...
    expect(modelBlock('ReviewRule')).toMatch(/\bprovider\s+String\s+@default\("deepseek"\)/);
    expect(modelBlock('ReviewRule')).toMatch(/\bmodel\s+String\s+@default\("deepseek-chat"\)/);
